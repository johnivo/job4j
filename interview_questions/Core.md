...
+ для объектов передается !!!копия!!! ссылки (не сама ссылка).
...
Потому, что буду сравниваться адреса в памяти на которые указывают ссылки, а не сами объекты. И они буду отличаться.
